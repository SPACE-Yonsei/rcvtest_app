 ...
 *
 * Purpose:
 * Extra scaffolding functions for the rcvtest_app unit test
 *
 * Notes:
...
#ifndef UT_RCVTEST_APP_H
#define UT_RCVTEST_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "RCVTEST_APP_Data_t" typedef.
 */
#include "rcvtest_app_events.h"
#include "rcvtest_app.h"

/*
 * Allow UT access to the global "RCVTEST_APP_Data" object.
 */
extern RCVTEST_APP_Data_t RCVTEST_APP_Data;

#endif /* UT_RCVTEST_APP_H */
