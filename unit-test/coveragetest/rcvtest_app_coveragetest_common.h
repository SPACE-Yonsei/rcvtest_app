 ...
 * @file
 *
 * Common definitions for all rcvtest_app coverage tests
 */

#ifndef RCVTEST_APP_COVERAGETEST_COMMON_H
#define RCVTEST_APP_COVERAGETEST_COMMON_H
...
#endif /* RCVTEST_APP_COVERAGETEST_COMMON_H */
